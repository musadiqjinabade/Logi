...
class ScanMoveRawMaterial extends Component {
    ...
    async Updatedata() {
        ...
        var Updatedata = await APIService.execute('POST', APIService.URLBACKEND + 'scanCheck/rawmaterial/quickmove', data)
        if (Updatedata.data.status == 200) {
            ToastAndroid.show("Raw Material Moved.", ToastAndroid.LONG, 25, 50);
...
export default withNavigation(ScanMoveRawMaterial);
