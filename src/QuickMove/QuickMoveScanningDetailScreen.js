...
const resetAction = StackActions.reset({
    index: 0,
    actions: [NavigationActions.navigate({ routeName: 'QuickMoveScanningItemsScreen' })],
});
...
class QuickMoveScanningDetailScreen extends Component {
    ...
    render() {
        return (
            <SafeAreaView style={{ flex: 1, flexDirection: 'column' }}>
                <Headers onBackHome={() => { this.refs.redirectHome.open() }} isHome={true} label={"Quick Move - " + this.props.navigation.state.params.item} onBack={() => this.props.navigation.goBack()} expanded={this.state.expanded} />
...
export default withNavigation(QuickMoveScanningDetailScreen);
