...
const resetAction = StackActions.reset({
    index: 0,
    actions: [NavigationActions.navigate({ routeName: 'ReaggregateItemsScreen' })],
});
class ReaggregateDetailScreen extends Component {
...
export default withNavigation(ReaggregateDetailScreen);
