...
const resetAction = StackActions.reset({
    index: 0,
    actions: [NavigationActions.navigate({ routeName: 'DeaggregateScanningScreen' })],
});
class DeaggregateItemsScreen extends Component {
    ...
    render() {
        ...
        return (
            <View style={{ flex: 1, flexDirection: 'column' }}>
                <Headers isHome={true} onBackHome={() => { this.props.navigation.navigate('Dashboard') }} label={'De-aggregate - 12345'} onBack={() => { this.props.navigation.goBack() }} expanded={this.state.expanded} />
                ...
                <ScrollView>
                    <View style={{ flex: 1, flexDirection: 'column' }}>
                        <View style={{ paddingLeft: wp('2%'), paddingRight: wp('2%'), justifyContent: 'space-between', flexDirection: 'row', marginTop: hp('1%') }}>
                            <Button onPress={() => { this.props.navigation.navigate('DeaggregateDetailScreen') }} style={styles.buttonStyle}>
                        ...
                        <View style={{ paddingLeft: wp('2%'), paddingRight: wp('2%') }}>
                            ...
                            <View style={{ marginTop: hp('0.5%'), flex: 1, flexDirection: 'row' }}>
                                ...
                                <Text style={styles.packagingValue} >40</Text>
                            </View>
                        </View>
...
export default withNavigation(DeaggregateItemsScreen);
