...
class PairIdScanningScreen extends Component {
    ...
    render() {
        ...
        return (
            <Container style={{ flex: 1, backgroundColor: '#F1EFEE' }}>
                <Headers isHome={true} onBackHome={() => { this.props.navigation.navigate('Dashboard') }} label={'Pair IDs - 129'} onBack={() => { this.props.navigation.goBack() }} expanded={this.state.expanded} />
            ...
            <View style={{ flex: 1, flexDirection: 'column', backgroundColor:'white' }}>
                ...
                {/* <View style={{ flex: 1, }}> */}
                    <View style={{
                        ...
                        <TouchableOpacity onPress={ () => { this.props.navigation.navigate('PairIdScanningItemsScreen') }}>
                            <LinearGradient
...
export default withNavigation(PairIdScanningScreen);
