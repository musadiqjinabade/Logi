...
class RMDeletebyscan extends Component {
    ...
    render() {
        console.log('delete scan', this.props.navigation.state.params.item, this.props.navigation.state.params.jobId, 'jobType:',this.props.navigation.state.params.jobType);
    ...
    async Updatedata(sequencenum) {
        ...
        var Updatedata = await APIService.execute('DELETE', APIService.URLBACKEND + 'rowmaterial/deleterm', data)
...
export default withNavigation(RMDeletebyscan);
