...
class RMCheckScanItemsScreen extends Component {
    ...
    async ScanSummary() {
        ...
        if (scan.data.data) {
            ...
            this.setState({ job_detail: scan.data.data.job_detail[0], Updatedata: responseData, packaging_details: scan.data.data.packeing_details, product_details: scan.data.data.product_details, job_type: scan.data.data.job_detail[0].job_type, loading: false }, () => {
...
export default withNavigation(RMCheckScanItemsScreen);
