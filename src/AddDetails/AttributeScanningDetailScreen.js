...
const resetAction = StackActions.reset({
    index: 0,
    actions: [NavigationActions.navigate({ routeName: 'AttributeScanningItemScreen' })],
});
class AttributeScanningDetailScreen extends Component {
...
export default withNavigation(AttributeScanningDetailScreen);
